...
class HudOverlayService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        return Notification.Builder(
            this,
            MeteoryApplication.CHANNEL_HUD
        )
            .setContentTitle(
                getString(
                    R.string.notification_hud_title
                )
            )
            .setContentText(
                getString(
                    R.string.notification_hud_desc
                )
            )
            .setSmallIcon(
    ...
    private fun startMetricsCollection() {
        ...
        scope.launch {
            ...
            while(isActive) {
                ...
                cpuValue =
                    "${SystemInfo.getCpuUsagePercent()}%"



                val ram =
                    SystemInfo.getRamInfo(
                        this@HudOverlayService
                    )


                ramValue =
                    "${ram.availableMb}MB libre"
